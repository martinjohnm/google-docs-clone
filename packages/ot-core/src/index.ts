...
import { DeleteOp, InsertOp, Op, OpsArrType, OpType, SnapshotType } from "@repo/types/ot-types"
...
export function reconstructorFromSnapshot(latestSnapshotFromDb : SnapshotType, opsArrAfterLatestSnapFromDb : OpsArrType[]) : {doc: string, version: number} {
